...
Control {
    ...
    contentItem: Item {
        ...
        ProgressBar {
            ...
            readonly property real progressBarWidth: progressBar.width - Sizes.dp(5)

            background: Rectangle {
                visible: progressBar.backgroundVisible
                anchors.verticalCenter: parent.verticalCenter
                implicitWidth: progressBar.progressBarWidth
