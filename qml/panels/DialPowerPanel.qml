...
Item {
    ...
    //public
    property int ePower
    property int ePowerTarget
    property int drivetrain: 0
    property int remainingKm: 500
    property int remainingPower: 80
    ...
    Behavior on ePowerTarget {
        PropertyAnimation { target: root; properties: "ePower"; to: ePowerTarget; duration: 1000 }
    }
    ...
    Image {
        ...
        width: Sizes.dp(71)
        height: Sizes.dp(294)
        source: Config.localAsset("dial-energy-areas", Style.theme)
    }
    ...
    Image {
        ...
        width: Sizes.dp(23)
        height: Sizes.dp(14)
        source: Config.localAsset("ic-battery", Style.theme)
    }
    ...
    Image {
        ...
        x: Sizes.dp(353)
        y: Sizes.dp(474)
        visible: root.remainingPower
        width: Sizes.dp(24)
        height: Sizes.dp(21)
        source: Config.localAsset("ic-chargingstation", Style.theme)
    }
