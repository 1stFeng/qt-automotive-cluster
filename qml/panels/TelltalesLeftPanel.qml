...
Item {
    ...
    Row {
        ...
        Image {
            ...
            source: Config.localAsset("/telltales/ic-low-beam")
        ...
        Image {
            ...
            fillMode: Image.PreserveAspectFit
            source: Config.localAsset("/telltales/ic-high-beam")
            anchors.verticalCenter: parent.verticalCenter
        }
        ...
        Image {
            ...
            fillMode: Image.PreserveAspectFit
            source: Config.localAsset("/telltales/ic-fog-lights")
            anchors.verticalCenter: parent.verticalCenter
        }
        ...
        Image {
            ...
            fillMode: Image.PreserveAspectFit
            source: Config.localAsset("/telltales/ic-stability-control")
            anchors.verticalCenter: parent.verticalCenter
        }
        ...
        Image {
            ...
            fillMode: Image.PreserveAspectFit
            source: Config.localAsset("/telltales/ic-seat-belt")
            anchors.verticalCenter: parent.verticalCenter
        }
        ...
        Image {
            ...
            fillMode: Image.PreserveAspectFit
            source: Config.localAsset("/telltales/ic-left-turn")
            anchors.verticalCenter: parent.verticalCenter
        }
    }
}
