...
Item {
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges { target: outSmallBg; opacity: 0; width: Sizes.dp(366.15) }
    ...
    Image {
        ...
        visible: true
        source: Config.localAsset("dial-small-bg", Style.theme)
    }
    ...
    Image {
        ...
        anchors.centerIn: parent
        visible: true
        source: Config.localAsset("dial-outer-circle-bg", Style.theme)
    }
    ...
    Image {
        ...
        z: 1
        visible: true
        source: Config.localAsset("dial-outer-circle-edge", Style.theme)
    }
    ...
    Image {
        ...
        z: 1
        visible: true
        source: Config.localAsset("dial-outer-circle-shadow", Style.theme)
    }
    ...
    Image {
        ...
        anchors.centerIn: parent
        visible: true
        source: Config.localAsset("dial-inner-circle", Style.theme)
    }
    ...
    Image {
        ...
        anchors.centerIn: parent
        visible: true
        source: Config.localAsset("dial-inner-circle_shadow")
    }
}
