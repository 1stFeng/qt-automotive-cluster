...
Item {
    ...
    Behavior on speedTarget {
        PropertyAnimation { target: root; properties: "speed"; to: speedTarget; duration: 1000 }
    }
    ...
    Image {
        ...
        source: Config.localAsset(root.speed > root.speedLimit ? "speed-limit-badge-red" : "speed-limit-badge")
        Label {
            anchors.centerIn: parent
    ...
    Rectangle {
        ...
        Image {
            ...
            height: width
            anchors.centerIn: parent
            source: Config.localAsset("dial-cruise-circle-shadow")
        }
        Image {
            id: cruiseCircle
            width: Sizes.dp(330)
            height: width
            anchors.centerIn: parent
            source: Config.localAsset("dial-cruise-circle", Style.theme)
        }
    }
    ...
    Image {
        ...
        width: Sizes.dp(35)
        height: Sizes.dp(31)
        source: Config.localAsset("ic-acc", Style.theme)
        Behavior on opacity {
